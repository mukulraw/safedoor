...
public class RegularNotification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regular_notification);
    ...
    public class RegularAdapter1 extends RecyclerView.Adapter<RegularAdapter1.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.regnotification_list_model, parent, false);
